...
namespace Bounds.Models
{
    public class BoundsDBInitializer : System.Data.Entity.CreateDatabaseIfNotExists<BoundsContext>
    {
        protected override void Seed(BoundsContext context)
        {
            ...
            {
                new b_Auth() { b_Auth_Name="功分配置", b_Auth_Group_ID = 0 },//1
                ...
                new b_Auth() { b_Auth_Name="我的功分", b_Auth_Group_ID = 47 },//56
                ...
                new b_Auth() { b_Auth_Name="固定功分配置", b_Auth_Group_ID = 47 },//81
                ...
                new b_Auth() { b_Auth_Name="新增功分", b_Auth_Group_ID = 81 },//85
                new b_Auth() { b_Auth_Name="删除功分", b_Auth_Group_ID = 81 },//86
                new b_Auth() { b_Auth_Name="编辑功分", b_Auth_Group_ID = 81 },//87
                ...
                new b_Auth() { b_Auth_Name="功分核查", b_Auth_Group_ID = 108 },//109
                ...
                new b_Auth() { b_Auth_Name="考勤/固定功分计算", b_Auth_Group_ID = 108 },//119
